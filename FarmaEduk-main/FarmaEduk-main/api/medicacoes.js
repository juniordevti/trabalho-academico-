...
import { cadastrarMedicamento, listarMedicamentos } from '../backend/src/controllers/medicamentoController.js';
...
export default async function handler(req, res) {
  if (req.method === 'GET') {
    ...
    return listarMedicamentos(req, res);
  }
  ...
  if (req.method === 'POST') {
    ...
    if (res.writableEnded) return;
    return cadastrarMedicamento(req, res);
  }
